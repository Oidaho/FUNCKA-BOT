...
## 🧰 Установка ##
  ...
  ---
  __Как только бот попадет в одну из модерируемых бесед, а так же в будущий лог-чат, нужно зарегистрировать беседу внутри ьазы данных. Для этого достаточно написать любое сообщение, но я рекомендую написать что-то типа РЕГИСТРАЦИЯ__
